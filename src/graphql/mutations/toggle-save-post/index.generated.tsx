...
export type ToggleSavePostMutationVariables = Types.Exact<{
  postId: Types.Scalars['Int'];
}>;


export type ToggleSavePostMutation = { toggleSavePost: { createdAt: any, post: { createdAt: any }, user: { createdAt: any } } };


export const ToggleSavePostDocument = gql`
  ...
  toggleSavePost(postId: $postId) {
    ...
    `;
export type ToggleSavePostMutationFn = Apollo.MutationFunction<ToggleSavePostMutation, ToggleSavePostMutationVariables>;

/**
 * __useToggleSavePostMutation__
 *
 * To run a mutation, you first call `useToggleSavePostMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useToggleSavePostMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [toggleSavePostMutation, { data, loading, error }] = useToggleSavePostMutation({
 *   variables: {
 *      postId: // value for 'postId'
 *   },
 * });
 */
export function useToggleSavePostMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<ToggleSavePostMutation, ToggleSavePostMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<ToggleSavePostMutation, ToggleSavePostMutationVariables>(ToggleSavePostDocument, options);
      }
export type ToggleSavePostMutationHookResult = ReturnType<typeof useToggleSavePostMutation>;
export type ToggleSavePostMutationResult = Apollo.MutationResult<ToggleSavePostMutation>;
export type ToggleSavePostMutationOptions = Apollo.BaseMutationOptions<ToggleSavePostMutation, ToggleSavePostMutationVariables>;