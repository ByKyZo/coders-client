...
export type RemoveFollowerMutationVariables = Types.Exact<{
  followerId: Types.Scalars['Int'];
}>;


export type RemoveFollowerMutation = { removeFollower: { userId: number } };
 ...
 * });
 */
export function useRemoveFollowerMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RemoveFollowerMutation, RemoveFollowerMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<RemoveFollowerMutation, RemoveFollowerMutationVariables>(RemoveFollowerDocument, options);
      }
