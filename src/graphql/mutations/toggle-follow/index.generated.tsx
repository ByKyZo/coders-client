...
export type ToggleFollowMutation = { toggleFollow: { follower: { id: number, username: string, followings: { total: number }, followers: { total: number } }, following: { id: number, username: string, followings: { total: number }, followers: { total: number } } } };
