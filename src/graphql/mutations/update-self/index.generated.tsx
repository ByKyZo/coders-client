...
export type UpdateSelfMutation = { updateSelf: { id: number, username: string, email: string, createdAt: any, roles: Array<{ level: string, label: string }>, profile: { displayname?: string | null, bio?: string | null, backroundPicture?: string | null } } };
...
export function useUpdateSelfMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateSelfMutation, UpdateSelfMutationVariables>) {
        ...
        return ApolloReactHooks.useMutation<UpdateSelfMutation, UpdateSelfMutationVariables>(UpdateSelfDocument, options);
      }
