...
export type UpdateSelfMutation = { updateSelf: { id: number, username: string, email: string, createdAt: any, roles: Array<{ level: number, label: string }>, profile: { displayname?: string | null, bio?: string | null, backroundPicture?: string | null } } };
