...
export type FollowSubscriptionVariables = Types.Exact<{ [key: string]: never; }>;


export type FollowSubscription = { follow: { follower: { id: number, followings: { total: number }, followers: { total: number } }, following: { id: number, followings: { total: number }, followers: { total: number } } } };
...
/**
 * __useFollowSubscription__
 *
 * To run a query within a React component, call `useFollowSubscription` and pass it any options that fit your needs.
 * When your component renders, `useFollowSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFollowSubscription({
 *   variables: {
 *   },
 * });
 */
export function useFollowSubscription(baseOptions?: ApolloReactHooks.SubscriptionHookOptions<FollowSubscription, FollowSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useSubscription<FollowSubscription, FollowSubscriptionVariables>(FollowDocument, options);
      }
export type FollowSubscriptionHookResult = ReturnType<typeof useFollowSubscription>;
export type FollowSubscriptionResult = Apollo.SubscriptionResult<FollowSubscription>;