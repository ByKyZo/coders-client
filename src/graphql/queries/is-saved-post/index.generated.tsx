...
export type IsSavedPostQueryVariables = Types.Exact<{
  postId: Types.Scalars['Int'];
}>;


export type IsSavedPostQuery = { isSavedPost: boolean };


export const IsSavedPostDocument = gql`
...
/**
 * __useIsSavedPostQuery__
 *
 * To run a query within a React component, call `useIsSavedPostQuery` and pass it any options that fit your needs.
 * When your component renders, `useIsSavedPostQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useIsSavedPostQuery({
 *   variables: {
 *      postId: // value for 'postId'
 *   },
 * });
 */
export function useIsSavedPostQuery(baseOptions: ApolloReactHooks.QueryHookOptions<IsSavedPostQuery, IsSavedPostQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<IsSavedPostQuery, IsSavedPostQueryVariables>(IsSavedPostDocument, options);
      }
export function useIsSavedPostLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<IsSavedPostQuery, IsSavedPostQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<IsSavedPostQuery, IsSavedPostQueryVariables>(IsSavedPostDocument, options);
        }
export type IsSavedPostQueryHookResult = ReturnType<typeof useIsSavedPostQuery>;
export type IsSavedPostLazyQueryHookResult = ReturnType<typeof useIsSavedPostLazyQuery>;
export type IsSavedPostQueryResult = Apollo.QueryResult<IsSavedPostQuery, IsSavedPostQueryVariables>;