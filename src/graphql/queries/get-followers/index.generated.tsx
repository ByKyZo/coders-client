...
export type FollowersQuery = { user: { followers: { total: number, list: Array<{ id: number, username: string, email: string, profile: { displayname?: string | null, profilePicture?: string | null, bio?: string | null } }> } } };
