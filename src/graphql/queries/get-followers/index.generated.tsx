...
export type FollowersQuery = { user: { followers: { total: number, list: Array<{ id: number, username: string, email: string, profile: { displayname?: string | null, profilePicture?: string | null } }> } } };
...
export function useFollowersQuery(baseOptions: ApolloReactHooks.QueryHookOptions<FollowersQuery, FollowersQueryVariables>) {
        ...
        return ApolloReactHooks.useQuery<FollowersQuery, FollowersQueryVariables>(FollowersDocument, options);
      }
export function useFollowersLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FollowersQuery, FollowersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<FollowersQuery, FollowersQueryVariables>(FollowersDocument, options);
        }
