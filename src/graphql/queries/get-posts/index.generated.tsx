...
export type PostsQuery = { me: { posts: { total: number, list: Array<{ id: number, body?: string | null, postParentId?: number | null, isFollowOnly?: boolean | null, createdAt: any, medias: Array<{ id: number, path: string }> }> } } };
