...
export type FeedQueryVariables = Types.Exact<{
  input?: Types.InputMaybe<Types.FeedInput>;
}>;


export type FeedQuery = { feed: { total: number, list: Array<{ id: number, draftRaw?: string | null, postParentId?: number | null, isFollowOnly?: boolean | null, createdAt: any, medias: Array<{ id: number, path: string }>, author: { id: number, username: string, profile: { profilePicture?: string | null, displayname?: string | null } } }> } };
