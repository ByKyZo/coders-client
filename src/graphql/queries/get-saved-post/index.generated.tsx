...
export type GetSavedPostQuery = { user: { savedPost: { total: number, list: Array<{ post: { id: number, draftRaw?: string | null, isFollowOnly?: boolean | null, createdAt: any, medias: Array<{ id: number, path: string }>, author: { id: number, username: string, profile: { profilePicture?: string | null, displayname?: string | null } } } }> } } };
