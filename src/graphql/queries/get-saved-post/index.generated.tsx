...
export type GetSavedPostQueryVariables = Types.Exact<{
  username: Types.Scalars['String'];
}>;


export type GetSavedPostQuery = { user: { savedPost: { total: number, list: Array<{ post: { id: number, draftRaw?: string | null, postParentId?: number | null, isFollowOnly?: boolean | null, createdAt: any, medias: Array<{ id: number, path: string }>, author: { id: number, username: string, profile: { profilePicture?: string | null, displayname?: string | null } } } }> } } };


export const GetSavedPostDocument = gql`
...
/**
 * __useGetSavedPostQuery__
 *
 * To run a query within a React component, call `useGetSavedPostQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSavedPostQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetSavedPostQuery({
 *   variables: {
 *      username: // value for 'username'
 *   },
 * });
 */
export function useGetSavedPostQuery(baseOptions: ApolloReactHooks.QueryHookOptions<GetSavedPostQuery, GetSavedPostQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetSavedPostQuery, GetSavedPostQueryVariables>(GetSavedPostDocument, options);
      }
export function useGetSavedPostLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetSavedPostQuery, GetSavedPostQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetSavedPostQuery, GetSavedPostQueryVariables>(GetSavedPostDocument, options);
        }
export type GetSavedPostQueryHookResult = ReturnType<typeof useGetSavedPostQuery>;
export type GetSavedPostLazyQueryHookResult = ReturnType<typeof useGetSavedPostLazyQuery>;
export type GetSavedPostQueryResult = Apollo.QueryResult<GetSavedPostQuery, GetSavedPostQueryVariables>;