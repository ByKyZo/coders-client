...
export type MeQuery = { me: { id: number, username: string, email: string, createdAt: any, followings: { total: number }, followers: { total: number }, profile: { displayname?: string | null, bio?: string | null, profilePicture?: string | null, backroundPicture?: string | null }, roles: Array<{ level: number, label: string }> } };
