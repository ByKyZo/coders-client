...
export type IsFollowQueryVariables = Types.Exact<{
  followerId: Types.Scalars['Int'];
  followingId: Types.Scalars['Int'];
}>;


export type IsFollowQuery = { isFollow: boolean };
...
export function useIsFollowQuery(baseOptions: ApolloReactHooks.QueryHookOptions<IsFollowQuery, IsFollowQueryVariables>) {
        ...
        return ApolloReactHooks.useQuery<IsFollowQuery, IsFollowQueryVariables>(IsFollowDocument, options);
      }
export function useIsFollowLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<IsFollowQuery, IsFollowQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<IsFollowQuery, IsFollowQueryVariables>(IsFollowDocument, options);
        }
