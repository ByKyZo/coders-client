...
export type UserQuery = { user: { id: number, username: string, email: string, createdAt: any, followings: { total: number }, followers: { total: number }, roles: Array<{ level: number, label: string }>, profile: { displayname?: string | null, bio?: string | null, profilePicture?: string | null, backroundPicture?: string | null } } };
