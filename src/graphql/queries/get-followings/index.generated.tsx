...
export type FollowingsQueryVariables = Types.Exact<{
  ...
  input?: Types.InputMaybe<Types.FollowInput>;
}>;


export type FollowingsQuery = { user: { followings: { total: number, list: Array<{ id: number, username: string, email: string, profile: { displayname?: string | null, profilePicture?: string | null } }> } } };
 ...
 * });
 */
export function useFollowingsQuery(baseOptions: ApolloReactHooks.QueryHookOptions<FollowingsQuery, FollowingsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<FollowingsQuery, FollowingsQueryVariables>(FollowingsDocument, options);
      }
export function useFollowingsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FollowingsQuery, FollowingsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<FollowingsQuery, FollowingsQueryVariables>(FollowingsDocument, options);
        }
