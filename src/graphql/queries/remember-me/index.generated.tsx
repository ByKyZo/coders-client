...
export type RememberMeQuery = { rememberMe: { accessToken: string, user: { id: number, username: string, profile: { displayname?: string | null }, roles: Array<{ level: string }> } } };
 ...
 * });
 */
export function useRememberMeQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<RememberMeQuery, RememberMeQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<RememberMeQuery, RememberMeQueryVariables>(RememberMeDocument, options);
      }
export function useRememberMeLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<RememberMeQuery, RememberMeQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<RememberMeQuery, RememberMeQueryVariables>(RememberMeDocument, options);
        }
