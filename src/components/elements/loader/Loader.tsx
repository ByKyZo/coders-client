  ...
  return (
    <div ref={containerRef} className="fixedS left-3/ left-1/4 top-1/4 hidden">
      ...
      <svg className={className} viewBox="0 0 80 69" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path className={'stroke-current'} ref={outsideRef} d="M2.59808 67.5L39.8372 3L77.0763 67.5H2.59808Z" strokeWidth={strokeWidth}/>
        <path className={'fill-current'} ref={innerRef} d="M19.5928 58.5L40 23.0092L60.4072 58.5H19.5928Z"  strokeWidth={strokeWidth}/>
      </svg>
    </div>
  );
};
